...
@section('title', 'नवीन वर्गवारी')
@section('page-title', 'नवीन वर्गवारी तयार करा')
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required
                           ...
                           placeholder="उदा: प्रकल्प">
                </div>

                <div>
                    <label for="slug" class="block text-sm font-medium text-gray-700 mb-1.5">Slug <span class="text-gray-400">(ऐच्छिक — आपोआप तयार होईल)</span></label>
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <label for="is_active" class="text-sm text-gray-700">सक्रिय (गॅलरीमध्ये दिसेल)</label>
                </div>
            </div>
