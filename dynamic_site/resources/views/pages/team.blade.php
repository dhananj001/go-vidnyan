                                    ...
                                    <div class="bg-gray-50 rounded-lg p-3 border border-gray-200">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-600 text-xs mt-1">प्रचार-प्रसिद्धी</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="bg-gray-50 rounded-lg p-3 border border-gray-200">
                                        <div class="flex items-center space-x-2">
                                            <div class="w-2 h-2 bg-orange-500 rounded-full"></div>
                                            <div>
                                                <span class="text-gray-700 font-medium">श्री. किशोर फडणीस</span>
                                                <p class="text-gray-600 text-xs mt-1">प्रचार-प्रसिद्धी</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="bg-gray-50 rounded-lg p-3 border border-gray-200">
                                        <div class="flex items-center space-x-2">
                                            ...
                                            <div>
                                                ...
                                                <p class="text-gray-600 text-xs mt-1">साप्ताहिक व्याख्यान संयोजक</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
