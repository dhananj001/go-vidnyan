    ...
    <header class="bg-white/95 backdrop-blur-md shadow-sm sticky top-0 z-50 border-b border-gray-100">
        <nav class="container mx-auto px-4 sm:px-6 py-3">
            ...
            <div id="mobile-menu" class="hidden md:hidden mt-4 pt-4 border-t border-gray-100 space-y-2">
                <a href="{{ url('/') }}" class="block py-2 px-3 {{ request()->is('/') ? 'text-green-600 font-semibold bg-green-50' : 'text-gray-700 hover:bg-gray-50' }} rounded smooth-transition">Home</a>
                <a href="{{ url('/about') }}" class="block py-2 px-3 {{ request()->is('about') ? 'text-green-700 bg-green-50 font-medium' : 'text-gray-700 hover:bg-gray-50' }} rounded smooth-transition">About</a>
                <a href="{{ url('/projects') }}" class="block py-2 px-3 {{ request()->is('projects*') ? 'text-green-700 bg-green-50 font-medium' : 'text-gray-700 hover:bg-gray-50' }} rounded smooth-transition">Work</a>
                <a href="{{ url('/awards') }}" class="block py-2 px-3 {{ request()->is('awards') ? 'text-green-700 bg-green-50 font-medium' : 'text-gray-700 hover:bg-gray-50' }} rounded smooth-transition">Awards</a>
                <a href="{{ url('/gallery') }}" class="block py-2 px-3 {{ request()->is('gallery') ? 'text-green-700 bg-green-50 font-medium' : 'text-gray-700 hover:bg-gray-50' }} rounded smooth-transition">Gallery</a>
                <a href="{{ url('/query') }}" class="block py-2 px-3 {{ request()->is('query') ? 'text-green-700 bg-green-50 font-medium' : 'text-gray-700 hover:bg-gray-50' }} rounded smooth-transition">Query</a>
                <a href="{{ url('/admin') }}" class="block py-2 px-3 text-gray-700 hover:bg-gray-50 rounded smooth-transition flex items-center space-x-2" title="Admin Login">
                ...
                <div class="border-t border-gray-200 mt-2 pt-2">
                    ...
                    <a href="{{ url('/lectures') }}" class="block py-2 px-3 text-gray-700 hover:bg-green-50 rounded smooth-transition">📅 साप्ताहिक व्याख्याने</a>
                    <a href="{{ url('/research') }}" class="block py-2 px-3 text-gray-700 hover:bg-orange-50 rounded smooth-transition">🔬 संशोधन कार्य</a>
                    <a href="{{ url('/nirmalya') }}" class="block py-2 px-3 text-gray-700 hover:bg-blue-50 rounded smooth-transition">♻️ निर्माल्य प्रकल्प</a>
                </div>
                <a href="{{ url('/contact') }}" class="block py-2 primary-green-bg text-white text-center rounded-lg mt-3 smooth-transition font-medium">Contact</a>
            </div>
        </nav>
    </header>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="text-green-100 text-sm">
                                ...
                                <a href="tel:+918888871310" class="text-orange-200 hover:text-white transition-colors">+91 8888871310</a>
                            </div>
                        </div>
                        <div class="flex items-center space-x-3">
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex space-x-3">
                            <a href="#" class="w-10 h-10 bg-blue-600/20 backdrop-blur-sm rounded-lg flex items-center justify-center border border-blue-600/30 hover:bg-blue-600/30 transition-colors">
