...
@section('title', 'नवीन व्हिडिओ')
@section('page-title', 'नवीन व्हिडिओ जोडा')
            ...
            <div class="space-y-5">
                <div>
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title') }}" required
                           ...
                           placeholder="उदा: पंचगव्य चिकित्सा प्रक्रिया">
                </div>

                <div>
                    <label for="description" class="block text-sm font-medium text-gray-700 mb-1.5">वर्णन <span class="text-gray-400">(ऐच्छिक)</span></label>
                    <textarea name="description" id="description" rows="3"
                              class="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:ring-2 focus:ring-green-500 focus:border-green-500 text-sm"
                              placeholder="व्हिडिओचे वर्णन">{{ old('description') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-400 mt-1">YouTube URL कोणत्याही प्रकारात पेस्ट करा</p>
                </div>
